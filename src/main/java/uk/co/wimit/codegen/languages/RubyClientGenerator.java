...
public class RubyClientGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("gem.mustache", gemFolder, "api.rb"));
        ...
        supportingFiles.add(new SupportingFile("version.mustache", apiFolder, "version.rb"));
    ...
    public String modelTestFileFolder() {
        return apiTestFileFolder() + File.separator + modelPackage.replace("/", File.separator);
    }
    ...
    public String toModelName(final String name) {
        ...
        if (isReservedWord(modelName)) {
            String camelizedModelName = camelize("Model" + modelName);
            LOGGER.warn(modelName + " (reserved word) cannot be used as model name. Renamed to " + camelizedModelName);
            return camelizedModelName;
        }
